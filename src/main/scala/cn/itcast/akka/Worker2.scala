...
/**
  ...
  */
class Worker2(val masterHost: String, val masterPort: Int, val memory: Int, val cores: Int) extends Actor{
...
object Worker2{
  ...
  def main(args: Array[String]): Unit = {
    ...
    val worker2 = actorSystem.actorOf(Props(new Worker2(masterHost, masterPort, memory, cores)), "Worker2")
